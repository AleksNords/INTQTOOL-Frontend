    ...
    return (
            <div className="grading-question">
                ...
                <RadioGroup key={"grading" + questionIndex} className="credit-radio-wrapper" row>
                    ...
                    <FormControlLabel label={"correct"} className="grading-button" value="correct" control={<Radio TouchRippleProps={{sx: {color: "#42c767"}}} className="grading-radio" icon={<CheckIcon sx={{fontSize: 50}}/>} checkedIcon={<CheckIcon sx={{fontSize: 50, color: "#42c767"}}/>} size={"large"}/>}/>
                    <FormControlLabel label={"incorrect"} className="grading-button" value="incorrect" control={<Radio TouchRippleProps={{sx: {color: "#F63E3E"}}} className="grading-radio" icon={<CloseIcon sx={{fontSize: 50}}/>} checkedIcon={<CloseIcon sx={{fontSize: 50, color: "#f63e3e"}}/>} size={"large"}/>}/>
                    <FormControlLabel label={"partly_correct"} className="grading-button" value="partly_correct" control={<Radio TouchRippleProps={{sx: {color: "#F0C11B"}}} className="grading-radio" icon={<PercentIcon sx={{fontSize: 50}}/>} checkedIcon={<PercentIcon sx={{fontSize: 50, color: "#f0c11b"}}/>} size={"large"}/>}/>
                </RadioGroup>
