...
export default function Quiz() {
    ...
    useEffect(() => {
        ...
        axios({
            method: "get",
            url: "https://quiz.web-tek.ninja:8080/quiz/" + id,
            headers: {
        ...
        axios({
            method: "get",
            url: "https://quiz.web-tek.ninja:8080/user/quizanswers/" + id,
            headers: {
                "Authorization": "Bearer " + isLogged.jwtToken
            }
        }).then(function (response) {
    ...
    function saveQuiz() {
        ...
        axios({
            method: "post",
            url: "https://quiz.web-tek.ninja:8080/user/saveanswer",
            headers: {
                "Authorization": "Bearer " + isLogged.jwtToken
            },
            data: temp
    ...
    function endQuiz() {
        ...
        axios({
            method: "post",
            url: "https://quiz.web-tek.ninja:8080/user/submitanswer",
            headers: {
                "Authorization": "Bearer " + isLogged.jwtToken
            },
            data: temp
